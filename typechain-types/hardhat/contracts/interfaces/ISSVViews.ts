...
export interface ISSVViewsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getBalance"
      | "getBurnRate"
...
export interface ISSVViews extends BaseContract {
  connect(runner?: ContractRunner | null): ISSVViews;
  waitForDeployment(): Promise<this>;

  interface: ISSVViewsInterface;
  ...
  getOperatorDeclaredFee: TypedContractMethod<
    ...
    [
      [boolean, bigint, bigint, bigint] & {
        isFeeDeclared: boolean;
        fee: bigint;
        approvalBeginTime: bigint;
        approvalEndTime: bigint;
      }
    ],
    "view"
  >;
  ...
  getValidator: TypedContractMethod<
    [owner: AddressLike, publicKey: BytesLike],
    [boolean],
    "view"
  >;

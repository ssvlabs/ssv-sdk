...
export interface ISSVDAOInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ISSVDAO extends BaseContract {
  connect(runner?: ContractRunner | null): ISSVDAO;
  waitForDeployment(): Promise<this>;

  interface: ISSVDAOInterface;

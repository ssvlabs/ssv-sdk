...
export interface SSVClustersInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "bulkExitValidator"
...
export interface SSVClusters extends BaseContract {
  connect(runner?: ContractRunner | null): SSVClusters;
  waitForDeployment(): Promise<this>;

  interface: SSVClustersInterface;

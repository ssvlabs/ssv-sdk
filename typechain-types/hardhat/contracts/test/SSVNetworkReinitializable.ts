...
export interface SSVNetworkReinitializableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "bulkExitValidator"
...
export interface SSVNetworkReinitializable extends BaseContract {
  connect(runner?: ContractRunner | null): SSVNetworkReinitializable;
  waitForDeployment(): Promise<this>;

  interface: SSVNetworkReinitializableInterface;
  ...
  initializeV2: TypedContractMethod<
    [newMinOperatorsPerCluster: BigNumberish],
    [void],
    "nonpayable"
  >;

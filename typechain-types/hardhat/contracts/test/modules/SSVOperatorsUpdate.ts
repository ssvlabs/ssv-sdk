...
export interface SSVOperatorsUpdateInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface SSVOperatorsUpdate extends BaseContract {
  connect(runner?: ContractRunner | null): SSVOperatorsUpdate;
  waitForDeployment(): Promise<this>;

  interface: SSVOperatorsUpdateInterface;

...
export interface SSVNetworkBasicUpgradeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "bulkExitValidator"
  ...
  encodeFunctionData(
    functionFragment: "resetNetworkFee",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface SSVNetworkBasicUpgrade extends BaseContract {
  connect(runner?: ContractRunner | null): SSVNetworkBasicUpgrade;
  waitForDeployment(): Promise<this>;

  interface: SSVNetworkBasicUpgradeInterface;
  ...
  resetNetworkFee: TypedContractMethod<
    [newFee: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "resetNetworkFee"

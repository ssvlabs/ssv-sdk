...
export interface SSVNetworkValidatorsPerOperatorUpgradeInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
...
export interface SSVNetworkValidatorsPerOperatorUpgrade extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): SSVNetworkValidatorsPerOperatorUpgrade;
  waitForDeployment(): Promise<this>;

  interface: SSVNetworkValidatorsPerOperatorUpgradeInterface;

...
export interface SSVNetworkUpgradeInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "bulkExitValidator"
...
export interface SSVNetworkUpgrade extends BaseContract {
  connect(runner?: ContractRunner | null): SSVNetworkUpgrade;
  waitForDeployment(): Promise<this>;

  interface: SSVNetworkUpgradeInterface;

...
export interface SSVStorageTInterface extends Interface {
  getEvent(nameOrSignatureOrTopic: "ModuleUpgraded"): EventFragment;
}
...
export interface SSVStorageT extends BaseContract {
  connect(runner?: ContractRunner | null): SSVStorageT;
  waitForDeployment(): Promise<this>;

  interface: SSVStorageTInterface;

...
export interface SSVNetworkUpgradeValidatorsPerOperatorInterface
  extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
...
export interface SSVNetworkUpgradeValidatorsPerOperator extends BaseContract {
  connect(
    runner?: ContractRunner | null
  ): SSVNetworkUpgradeValidatorsPerOperator;
  waitForDeployment(): Promise<this>;

  interface: SSVNetworkUpgradeValidatorsPerOperatorInterface;

...
export interface SSVNetworkValidatorsPerOperatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "bulkExitValidator"
...
export interface SSVNetworkValidatorsPerOperator extends BaseContract {
  connect(runner?: ContractRunner | null): SSVNetworkValidatorsPerOperator;
  waitForDeployment(): Promise<this>;

  interface: SSVNetworkValidatorsPerOperatorInterface;

...
import type {
  ISSVClusters,
  ISSVClustersInterface,
} from "../../../../hardhat/contracts/interfaces/ISSVClusters";
...
export class ISSVClusters__factory {
  static readonly abi = _abi;
  static createInterface(): ISSVClustersInterface {
    return new Interface(_abi) as ISSVClustersInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ISSVClusters {
    return new Contract(address, _abi, runner) as unknown as ISSVClusters;
  }
}

...
import type {
  ISSVOperators,
  ISSVOperatorsInterface,
} from "../../../../hardhat/contracts/interfaces/ISSVOperators";
...
export class ISSVOperators__factory {
  static readonly abi = _abi;
  static createInterface(): ISSVOperatorsInterface {
    return new Interface(_abi) as ISSVOperatorsInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ISSVOperators {
    return new Contract(address, _abi, runner) as unknown as ISSVOperators;
  }
}

...
if (DataView && exports.getTag(new DataView(new ArrayBuffer(1))) != dataViewTag$2 || Map$1 && exports.getTag(new Map$1()) != mapTag$3 || Promise$1 && exports.getTag(Promise$1.resolve()) != promiseTag || Set$1 && exports.getTag(new Set$1()) != setTag$3 || WeakMap$1 && exports.getTag(new WeakMap$1()) != weakMapTag$1) {

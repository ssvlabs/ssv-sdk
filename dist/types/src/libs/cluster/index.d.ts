...
export declare const createClusterManager: (config: ConfigReturnType) => {
    deposit: RemoveConfigArg<(config: ConfigReturnType, { args: { id, amount }, ...writeOptions }: Omit<import("viem").SimulateContractParameters, "address" | "value" | "account" | "args" | "chain" | "abi" | "functionName"> & {
        args: {
            id: string;
            amount: bigint;
            options?: {
    ...
    withdraw: RemoveConfigArg<(config: ConfigReturnType, { args: { id, amount }, ...writeOptions }: Omit<import("viem").SimulateContractParameters, "address" | "value" | "account" | "args" | "chain" | "abi" | "functionName"> & {
        args: {
            id: string;
            amount: bigint;
        };
    ...
    liquidate: RemoveConfigArg<(config: ConfigReturnType, { args: { id }, ...writeOptions }: Omit<import("viem").SimulateContractParameters, "address" | "value" | "account" | "args" | "chain" | "abi" | "functionName"> & {
        args: {
            id: string;
        };
    }) => Promise<{
    ...
    reactivate: RemoveConfigArg<(config: ConfigReturnType, { args: { id, amount }, ...writeOptions }: Omit<import("viem").SimulateContractParameters, "address" | "value" | "account" | "args" | "chain" | "abi" | "functionName"> & {
        args: {
            id: string;
            amount: bigint;
        };
    ...
    removeValidators: RemoveConfigArg<(config: ConfigReturnType, { args: { id, publicKeys }, ...writeOptions }: Omit<import("viem").SimulateContractParameters, "address" | "value" | "account" | "args" | "chain" | "abi" | "functionName"> & {
        args: {
            id: string;
    ...
    setFeeRecipient: RemoveConfigArg<(config: ConfigReturnType, { args: { recipient }, ...writeOptions }: Omit<import("viem").SimulateContractParameters, "address" | "value" | "account" | "args" | "chain" | "abi" | "functionName"> & {
        args: {
            recipient: `0x${string}`;
        };
    }) => Promise<{
    ...
    exitValidators: RemoveConfigArg<(config: ConfigReturnType, { args: { publicKeys, operatorIds }, ...writeOptions }: Omit<import("viem").SimulateContractParameters, "address" | "value" | "account" | "args" | "chain" | "abi" | "functionName"> & {
        args: {
            publicKeys: `0x${string}`[];
            operatorIds: bigint[];
        };

...
exports.KeysharesValidationErrors = void 0;
(function(KeysharesValidationErrors) {
  KeysharesValidationErrors[KeysharesValidationErrors["OperatorDoesNotExist"] = 0] = "OperatorDoesNotExist";
  KeysharesValidationErrors[KeysharesValidationErrors["OperatorMismatch"] = 1] = "OperatorMismatch";
  KeysharesValidationErrors[KeysharesValidationErrors["ValidatorAlreadyExists"] = 2] = "ValidatorAlreadyExists";
  KeysharesValidationErrors[KeysharesValidationErrors["ClusterMismatch"] = 3] = "ClusterMismatch";
  KeysharesValidationErrors[KeysharesValidationErrors["DuplicateValidatorKeys"] = 4] = "DuplicateValidatorKeys";
  KeysharesValidationErrors[KeysharesValidationErrors["InconsistentOperatorPublicKeys"] = 5] = "InconsistentOperatorPublicKeys";
  KeysharesValidationErrors[KeysharesValidationErrors["InconsistentOperators"] = 6] = "InconsistentOperators";
})(exports.KeysharesValidationErrors || (exports.KeysharesValidationErrors = {}));
const KeysharesValidationErrorsMessages = {
  [exports.KeysharesValidationErrors.OperatorDoesNotExist]: "Operator not found. Please verify the operator ID.",
  [exports.KeysharesValidationErrors.OperatorMismatch]: "Operator details mismatch. Check provided information.",
  [exports.KeysharesValidationErrors.ValidatorAlreadyExists]: "Validator public key already in use. Must be unique.",
  [exports.KeysharesValidationErrors.ClusterMismatch]: "The operators in the provided keyshares do not match the provided operators. Please ensure the keyshares correspond to the cluster you are trying to register.",
  [exports.KeysharesValidationErrors.DuplicateValidatorKeys]: "Duplicate validator keys detected. Each must be unique.",
  [exports.KeysharesValidationErrors.InconsistentOperatorPublicKeys]: "Operator public keys mismatch. Verify operator data.",
  [exports.KeysharesValidationErrors.InconsistentOperators]: "Inconsistent operator IDs across keyshares. Check all entries."
};
...
const validateConsistentOperatorIds = (keyshares) => {
  ...
  keyshares.every(({ payload, data }) => {
    ...
    if (!valid) {
      throw new KeysharesValidationError(exports.KeysharesValidationErrors.InconsistentOperators);
    }
    return true;
  });
  return operatorIds;
...
const ensureValidatorsUniqueness = (keyshares) => {
  ...
  if (set.size !== keyshares.length) {
    throw new KeysharesValidationError(exports.KeysharesValidationErrors.DuplicateValidatorKeys);
  }
  return true;
};
const validateConsistentOperatorPublicKeys = (keyshares, operators) => {
  ...
  if (!valid) {
    throw new KeysharesValidationError(exports.KeysharesValidationErrors.InconsistentOperatorPublicKeys);
  }
  return valid;
};
...
exports.GetClusterBalanceDocument = GetClusterBalanceDocument;
exports.GetClusterDocument = GetClusterDocument;
exports.GetClusterSnapshotDocument = GetClusterSnapshotDocument;
exports.GetClustersDocument = GetClustersDocument;
exports.GetOperatorDocument = GetOperatorDocument;
exports.GetOperatorsDocument = GetOperatorsDocument;
exports.GetOwnerNonceByBlockDocument = GetOwnerNonceByBlockDocument;
exports.GetOwnerNonceDocument = GetOwnerNonceDocument;
exports.GetValidatorDocument = GetValidatorDocument;
exports.GetValidatorsDocument = GetValidatorsDocument;

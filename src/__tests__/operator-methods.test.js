...
const mockAccount = '0x2234567890123456789012345678901234567890';
const mockZeroAddress = '0x0000000000000000000000000000000000000000';
const mockOtherAddress = '0x3234567890123456789012345678901234567890';
const mockConfig = {
    walletClient: {
        account: {
...
// Mock operator data
const createMockOperator = (overrides) => ({
    id: mockOperatorId,
    publicKey: '0x1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890',
    validatorCount: '0',
    isPrivate: false,
    whitelisted: [],

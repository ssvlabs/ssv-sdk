...
describe('Cluster Methods', () => {
    describe('registerValidators', () => {
        it('should register a single validator', async () => {
            ...
            expect(mockConfig.contract.ssv.write.registerValidator).toHaveBeenCalledWith(expect.objectContaining({
                args: {
                    amount: 1000n,
                    cluster: mockCluster,
        ...
        it('should bulk register multiple validators', async () => {
            ...
            expect(result).toBeDefined();
            expect(mockConfig.contract.ssv.write.bulkRegisterValidator).toHaveBeenCalledWith(expect.objectContaining({
                args: {
                    amount: 1000n,
                    cluster: mockCluster,
                    operatorIds: mockOperatorIdsBigInt,

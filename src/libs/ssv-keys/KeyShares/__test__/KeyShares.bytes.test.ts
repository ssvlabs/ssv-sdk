...
describe('KeyShares.buildSharesFromBytes', () => {
  ...
  it('should correctly build shares from valid bytes and operator count', () => {
    ...
    const operatorCount =
      mockKeySharesItemWithOperators.payload.operatorIds.length;
  ...
  it('should handle invalid byte string format', () => {
    ...
    expect(() =>
      keySharesItem.buildSharesFromBytes(invalidBytes, operatorCount),
    ).toThrow();
  });
  ...
  it('should handle invalid operator count', () => {
    ...
    expect(() =>
      keySharesItem.buildSharesFromBytes(bytes, invalidOperatorCount),
    ).toThrow();
  });
});

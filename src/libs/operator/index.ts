...
export const createOperatorManager = (config: ConfigReturnType) => ({
  registerOperator: registerOperator.bind(null, config) as RemoveConfigArg<
    typeof registerOperator
  >,
  ...
  withdrawAllOperatorEarningsSSV: withdrawAllOperatorEarningsSSV.bind(
    null,
    config,
  ) as RemoveConfigArg<typeof withdrawAllOperatorEarningsSSV>,
  ...
  setOperatorWhitelistingContract: setOperatorWhitelists.bind(
    null,
    config,
  ) as RemoveConfigArg<typeof setOperatorWhitelists>,
  removeOperatorWhitelistingContract:
    config.contract.ssv.write.removeOperatorsWhitelists,
  ...
  cancelDeclaredOperatorFee:
    config.contract.ssv.write.cancelDeclaredOperatorFee,

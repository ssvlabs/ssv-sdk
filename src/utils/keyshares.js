...
export const KeysharesValidationErrorsMessages = {
...
export const validateConsistentOperatorIds = (keyshares) => {
...
export const ensureValidatorsUniqueness = (keyshares) => {
...
export const validateConsistentOperatorPublicKeys = (keyshares, operators) => {
...
export const ensureNoKeysharesErrors = (keyshares) => {

...
export enum SsvNetworkUpgradeBlock_OrderBy {
  BlockNumber = 'blockNumber',
  BlockTimestamp = 'blockTimestamp',
  Id = 'id',
  TransactionHash = 'transactionHash',
...
export type GetOperatorsQuery = { operators: Array<{ id: string, publicKey: Address, validatorCount: string, isPrivate: boolean, whitelistedContract: Address, fee: string, ssvFee: string, whitelisted: Array<{ id: Address }> }> };

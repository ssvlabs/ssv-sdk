...
export enum OperatorWithdrawnSsv_OrderBy {
  blockNumber = 'blockNumber',
  blockTimestamp = 'blockTimestamp',
  id = 'id',
  operatorId = 'operatorId',

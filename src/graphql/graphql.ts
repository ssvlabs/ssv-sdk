...
export type GetClustersQuery = { clusters: Array<{ id: string, active: boolean, validatorCount: string, balance: string, index: string, networkFeeIndex: string, operatorIds: Array<string>, effectiveBalance: string }> };

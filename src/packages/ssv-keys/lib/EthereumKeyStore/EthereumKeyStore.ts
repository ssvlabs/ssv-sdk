...
import { default as scrypt } from 'scrypt-js';
const syncScrypt = scrypt.syncScrypt;
import { default as ethereumWallet } from 'ethereumjs-wallet';
// @ts-expect-error its not typed
const Wallet = ethereumWallet.default as typeof ethereumWallet;
import { keccak256, sha256 } from 'ethereumjs-util';
import {
  EthereumWalletError,
  KeyStoreDataFormatError,
  KeyStoreInvalidError,
  KeyStorePasswordError,
} from '../exceptions/keystore';
